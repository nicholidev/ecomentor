...
import { VendureLogger } from './logger/ecomentor-logger';
...
/**
 * @description
 * Defines payment-related options in the {@link EcomentorConfig}.
 *
 ...
 * [`EcomentorConfig`](https://github.com/vendure-ecommerce/vendure/blob/master/server/src/config/vendure-config.ts) interface.
 *
 * @docsCategory configuration
 * */
export interface EcomentorConfig {
    /**
     * @description
...
/**
 * @description
 * This interface represents the EcomentorConfig object available at run-time, i.e. the user-supplied
 * config values have been merged with the {@link defaultConfig} values.
 *
 * @docsCategory configuration
 */
export interface RuntimeEcomentorConfig extends Required<EcomentorConfig> {
...
export type PartialEcomentorConfig = DeepPartialSimple<EcomentorConfig>;

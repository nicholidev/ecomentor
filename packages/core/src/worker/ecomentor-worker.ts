...
export class EcomentorWorker {
     ...
     */
    async startJobQueue(): Promise<EcomentorWorker> {
     ...
     * @since 1.2.0
     */
    async startHealthCheckServer(healthCheckConfig: WorkerHealthCheckConfig): Promise<EcomentorWorker> {
